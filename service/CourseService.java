...
{
    private final Map<String, Course> courses = new HashMap<>();   //takes in courseid and course object

    private final Map<String, List<Student>> enrolledStudents = new HashMap<>(); // takes in courseid and list of students enrolled in the course
    ...
    } //puts the course into the courses hashmap
